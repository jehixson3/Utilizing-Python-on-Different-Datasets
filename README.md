Utilizing Python with Different Datasets:
...
PyPoll shows the summarization of polling data for a town election.  The results include the total number of votes cast and a complete list of candidates who received votes in the race. The results also show the percentage of votes each candidate won and the total number of votes each candidate recieved.  Finally the results show the winner of the election based on popular vote.
